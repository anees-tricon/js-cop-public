/**
 * A JS based puzzle on logical operators and working with test cases.
 * Also involves some TS pratice.
 *
 * Author: anees@triconinfotech.com
 */
 ...
 */
export const isActiveMonth: IsActive = (
  monthToBeChecked,
  yearToBeChecked,
  start = null,
  end = null
